...
//                         <a href="index.php?page=routedash&id="` + data.route_id + `>View</a>
...
//     document.getElementById("route_id").value = selectedRecord.cells[1].innerHTML;
...
//     $.ajax({
//         type: 'PUT',
//         url: baseUrl + "/routess/" + selectedRecordID,
//         dataType: 'json',
//         data: updateData,
//         contentType: "application/json; charset=utf-8",
//         cache: false,
